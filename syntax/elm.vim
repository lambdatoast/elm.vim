...
" Libraries
syn keyword elmCoreLibrary List Time Collage Prelude Random Signal Http Set Color Keyboard Text WebSocket Automaton Mouse Dict Char Maybe Json Window Experimental JavaScript Either Date Matrix2D Element Touch Input
...
" Color
syn keyword elmBuiltinFunction rgba rgb red lime blue yellow cyan magenta black white gray grey maroon navy green teal purple violet forestGreen complement hsva hsv linear radial
" Date
